  ...
  return (
    <div className="bg-white text-black min-h-screen py-12 px-6 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto">
        {/* Tiêu đề chính */}
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Privacy Policy for TBK Best</h1>

        {/* Ngày cập nhật */}
        <p className="text-gray-600 mb-8">Last updated: February 10, 2025</p>

        {/* Phần giới thiệu */}
        <section className="mb-10">
          <p className="text-lg leading-relaxed">
            At TBK Best, accessible from tbkbest.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by TBK Best and how we use it.
          </p>
          <p className="text-lg leading-relaxed mt-4">
            If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
          </p>
          <p className="text-lg leading-relaxed mt-4">
            This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in TBK Best. This policy is not applicable to any information collected offline or via channels other than this website.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            ...
            <li>
              <strong>Application</strong> refers to TBK Best, the software program provided by the Company.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TBK Best, 1234 Privacy Lane, Data City, TX 56789.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to TBK Best, accessible from tbkbest.com.
            </li>
            <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-lg leading-relaxed mt-4">
            Please note, however, that We may need to retain certain information when we have an ongoing legitimate business need to do so (for example, to comply with applicable legal, tax, or accounting requirements).
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <h3 className="text-xl font-medium mt-6 mb-2">Law enforcement</h3>
          <p className="text-lg leading-relaxed">
            Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
          </p>
          <h3 className="text-xl font-medium mt-6 mb-2">Other legal requirements</h3>
          <p className="text-lg leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 mt-4 space-y-2 text-lg leading-relaxed">
            <li>By email: privacy@tbkbest.com</li>
            <li>By visiting this page on our website: tbkbest.com/contact</li>
            <li>By phone number: +1-800-555-1234</li>
          </ul>
        </section>
